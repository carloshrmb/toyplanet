...
export const metadata: Metadata = {
  ...
  description:
    "¡Niños en un mundo de diversión! Salón de juegos y eventos infantiles para niños de 1 a 12 años en Las Quintas, Culiacán. Albercas de pelotas, resbaladillas, zona arcade y paquetes de fiesta. Abierto todos los días de 11:00 AM a 7:00 PM.",
  keywords: [
